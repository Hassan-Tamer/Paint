...
public class MainWindow extends javax.swing.JFrame implements Node{
    ...
    private void initComponents() {
        ...
        SquareBtn.setBackground(new java.awt.Color(153, 255, 255));
        SquareBtn.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
    ...
    private void CircleBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CircleBtnActionPerformed
        ...
        Point p = new Point();
        p = getVariable();
        if(p == null )          //No operation can be done if the user closed the tab while taking the input
            return;
        int X = ((int)p.getX());        //Getting integers from Point
        int Y = ((int)p.getY());
        // try{
        int Radius = getVariable("Radius" , "Circle's Radius");
        if(Radius == -1)        //indicates that the user closed the window
            return;
            
        
        Circle c = new Circle(new Point(X,Y),Color.BLACK,Color.WHITE,Radius);
        D.addShape(c);
        AddComboBox("Circle");
    ...
    private void LineBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LineBtnActionPerformed
        ...
        Line l = new Line(new Point(X1,Y1) , new Point(X2,Y2) , Color.BLACK);
        D.addShape(l);
        AddComboBox("Line");
    ...
    private void SquareBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SquareBtnActionPerformed
        ...
        int side = getVariable("Side Length" , "Square's Length");
        
        if(side == -1)  //indicates that the user closed the window
            return;


        Rectangle sq = new Rectangle(new Point(X,Y),Color.BLACK,Color.WHITE,side,side);
        D.addShape(sq);
        AddComboBox("Square");
    ...
    private void RectangleBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RectangleBtnActionPerformed
       //Getting data to draw rectangle
        ...
        Rectangle rec = new Rectangle(new Point(X,Y),Color.BLACK,Color.WHITE,Width,Height);
